...
typedef InputCounterWidgetBuilder = Widget Function(
  /// The build context for the CustomTextField
  BuildContext context, {

  /// The length of the string currently in the input.
  @required int currentLength,

  /// The maximum string length that can be entered into the CustomTextField.
  @required int maxLength,

  /// Whether or not the CustomTextField is currently focused.  Mainly provided for
  /// the [liveRegion] parameter in the [Semantics] widget for accessibility.
  @required bool isFocused,
});

class _CustomTextFieldSelectionGestureDetectorBuilder
...
/// ## Reading values
///
/// A common way to read a value from a CustomTextField is to use the [onSubmitted]
/// callback. This callback is applied to the text field's current value when
/// the user finishes editing.
///
/// {@tool dartpad --template=stateful_widget_material}
///
/// This sample shows how to get a value from a CustomTextField via the [onSubmitted]
/// callback.
///
/// ```dart
...
/// callback.
///
/// Keep in mind you can also always read the current string from a CustomTextField's
...
class CustomTextField extends StatefulWidget {
  ...
  /// {@template flutter.material.CustomTextField.onTap}
...
class _CustomTextFieldState extends State<CustomTextField>
  ...
  void initState() {
    super.initState();
    _selectionGestureDetectorBuilder =
        _CustomTextFieldSelectionGestureDetectorBuilder(state: this);
